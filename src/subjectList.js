const subjectList = {
  ...
  ece: ["calculus and linear algebra", "engineering drawing", "basic electrical engineering", "modern physics", "network analysis and synthesis", "vector calculus and differential calculus", "electronics circuits and simulation", "programming in c", "integral transforms and complex analysis", "analog communication engineering", "industrial electronics", "electromagnetic field theory", "digital electronics", "antenna and wave propgation", "digital communication", "embedded systems and microcontrollers", "signal processing and linear systems", "constrol systems"]
};
...
const shortNames = {
  ...
  ece: ["cla", "eg", "bee","mp","nas", "vcdee ", "ecs", "pce", "itca", "ace", "ieng", "eft", "del","awp","digc", "esm", "spls", "csys"]
};
